...
const makeCourse = (state: 'draft' | 'published' | 'archived' = 'published'): Course =>
  new Course({ id: 'c1', title: 'T', description: 'D', coverImageUrl: null, state, createdBy: 'u1', semesterCount: 1, publishedAt: '2026-01-01T00:00:00.000Z', deletedAt: null, createdAt: '2026-01-01T00:00:00.000Z', updatedAt: '2026-01-01T00:00:00.000Z' });
